...
namespace System.Net.FtpClient {
    ...
    public class FtpListItem : IFtpListItem, IComparable {
        ...
        /// <summary>
        /// Sorts this list item in a list.  Directory types come first, then files.
        /// </summary>
        /// <param name="obj"></param>
        /// <returns></returns>
        public int CompareTo(object obj)
        {
            FtpListItem item = obj as FtpListItem;
            int equality = 0;
            if (item != null)
            {
                if (item.Type == this.Type)
                {
                    equality = this.Name.CompareTo(item.Name);
                }
            ...
            {
                throw new InvalidCastException("Could not cast object to type FtpListItem.");
            }
