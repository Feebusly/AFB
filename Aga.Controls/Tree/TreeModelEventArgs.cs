...
namespace Aga.Controls.Tree
{
	...
	public class TreeModelEventArgs: TreePathEventArgs
	{
        ...
        private NodeChangeTypes _changeType;
        public NodeChangeTypes ChangeType
        {
		...
		/// <param name="parent">Path to a parent node</param>
		/// <param name="children">Child nodes</param>
		public TreeModelEventArgs(TreePath parent, object[] children, NodeChangeTypes changeType)
			: this(parent, null, children, changeType)
		{
		}
		...
		/// <param name="indices">Indices of children in parent nodes collection</param>
		/// <param name="children">Child nodes</param>
        public TreeModelEventArgs(TreePath parent, int[] indices, object[] children, NodeChangeTypes changeType)
			: base(parent)
		{
			if (children == null)
				throw new ArgumentNullException();
