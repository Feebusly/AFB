...
namespace Aga.Controls.Tree.NodeControls
{
	public class NodeCheckBox : BindableControl
	{
        ...
        private bool _reflectState;
        [DefaultValue(false)]
        [Description("Reflects the new checkbox state up and down the checked node's tree.")]
        public bool ReflectState
        {
            get { return _reflectState; }
            set { _reflectState = value; }
        }
