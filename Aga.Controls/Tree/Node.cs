	...
	public class Node
	{
		...
		public virtual string Text
		{
			...
			set 
			{
				...
				{
					_text = value;
					NotifyModel(NodeChangeTypes.TextChanged);
				}
			}
		}
		...
		public virtual CheckState CheckState
		{
			...
			set 
			{
				...
				{
					_checkState = value;
					NotifyModel(NodeChangeTypes.CheckStateChanged);
				}
			}
		}
		...
		protected void NotifyModel(NodeChangeTypes changeType)
		{
			...
			if (model != null && Parent != null)
			{
				...
				if (path != null)
				{
					TreeModelEventArgs args = new TreeModelEventArgs(
                        path, new int[] { Index }, new object[] { this }, changeType);
